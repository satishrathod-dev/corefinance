    ...
    <ResponsiveContainer width="100%" height={350}>
      <BarChart data={data}>
        <XAxis
          ...
          axisLine={false}
        />
        <YAxis stroke={isDark ? "#888888" : "#333333"} fontSize={12} tickLine={false} axisLine={false} />
        <Tooltip content={<CustomTooltip />} />
        <Bar dataKey="newAccounts" fill={isDark ? "#adfa1d" : "#0ea5e9"} radius={[4, 4, 0, 0]} />
        <Bar dataKey="totalAccounts" fill={isDark ? "#1e40af" : "#3b82f6"} radius={[4, 4, 0, 0]} />
      </BarChart>
    </ResponsiveContainer>
  )
}
